...
class WhisperSpeechRecognitionModule(AbstractActionProcess):
    ...
    def process(self, data_in):
        ...
        self.logger().debug(f"Resampling conversion {resampling_time - data_conversion_time}")
        self.logger().debug(f"Pad or trim conversion {pad_or_trim_time - resampling_time}")
        ...
        self.logger().info(f"Detected language {result.language} in {end_time - start_time}")
